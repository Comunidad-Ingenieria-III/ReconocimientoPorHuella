package documento_entrega.documetoentregaformulario;
...
public class ControladorDocumentoEntrega implements Initializable {

    private FacadeCargo facadeCargo = new FacadeCargo();
    private FacadeTipoDocumento facadeTipoDocumento = new FacadeTipoDocumento();
    private PersonalSaludFacade personalSaludFacade = new PersonalSaludFacade();
    ...
    public void iniciarCbxTipoDocumento() {
        ObservableList<DtoTipoDocumento> listatipodocumetos = FXCollections.observableArrayList(facadeTipoDocumento.cargarTipoDocumento());
        cbx_tipoDocumento.setItems(listatipodocumetos);
    }
